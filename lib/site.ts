...
export const SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL || "https://www.gridmindhq.com").replace(/\/$/, "");
...
export const PUBLIC_ROUTES = ["/", "/gpu-prices", "/get-started", "/dashboard", "/routing", "/gridscore", "/map", "/simulator", "/budget", "/marketplace", "/security", "/privacy", "/terms"];
